...
const Project = () => {
  ...
  const projectsData = [
    { id: 17, name: 'TatoFood', techs: ['html5', 'css3', 'javascript', 'jquery'] },
    { id: 14, name: 'Justice', techs: ['html5', 'css3', 'javascript', 'bootstrap', 'jquery'] },
    { id: 15, name: 'Magical Effect', techs: ['html5', 'css3', 'javascript', 'jquery'] },
    { id: 16, name: 'Crystal Heart Store', techs: ['html5', 'css3', 'javascript', 'jquery'] },
    { id: 13, name: 'Inspired Gamer', techs: ['html5', 'css3', 'javascript', 'bootstrap'] },
    { id: 12, name: 'Every Running', techs: ['html5', 'css3', 'javascript', 'bootstrap'] },
    { id: 11, name: 'Plus Anime', techs: ['html5', 'css3', 'javascript'] },
    { id: 10, name: 'Elegant Hand', techs: ['html5', 'css3', 'javascript'] },
    { id: 9, name: 'Life on Paper', techs: ['html5', 'css3', 'javascript'] },
    { id: 8, name: 'Shop Tec', techs: ['html5', 'css3', 'javascript', 'sass'] },
    { id: 7, name: 'Power Engine', techs: ['html5', 'css3', 'javascript'] },
    { id: 6, name: 'Spider-Man Fan Page', techs: ['html5', 'css3', 'javascript', 'bootstrap'] },
    { id: 5, name: 'PremierFood', techs: ['html5', 'css3', 'javascript'] },
    { id: 3, name: 'Portfolio', techs: ['html5', 'css3', 'javascript'] },
  ];
      ...
      <main>
        <section className="proyectos mas-proyect" id="proyectos">
          <h1 className="heading" data-section="Nav" data-value="projects">
            ...
            />
            <span style={{ fontSize: '0.7em', display: 'block', marginTop: '10px', fontWeight: '300' }}>International Projects</span>
          </h1>
          ...
          {projectsData.map((project) => (
            <div key={project.id} className="projects__item">
              <div className="project-card">
                <a onClick={() => {
                  if (project.id === 17) cambiarEstadoModal17(true);
                  else if (project.id === 14) cambiarEstadoModal14(true);
                  else if (project.id === 15) cambiarEstadoModal15(true);
                  else if (project.id === 16) cambiarEstadoModal16(true);
                  else if (project.id === 13) cambiarEstadoModal13(true);
                  else if (project.id === 12) cambiarEstadoModal12(true);
                  else if (project.id === 11) cambiarEstadoModal11(true);
                  else if (project.id === 10) cambiarEstadoModal10(true);
                  else if (project.id === 9) cambiarEstadoModal9(true);
                  else if (project.id === 8) cambiarEstadoModal8(true);
                  else if (project.id === 7) cambiarEstadoModal7(true);
                  else if (project.id === 6) cambiarEstadoModal6(true);
                  else if (project.id === 5) cambiarEstadoModal5(true);
                  else if (project.id === 3) cambiarEstadoModal3(true);
                }}>
                  <img src={proyectsImg(`./proyecto-${project.id}.jpg`)} alt={project.name} className="projects__img" />
                </a>
                <div className="project-info">
                  <h3 className="project-name">{project.name}</h3>
                  <div className="project-techs">
                    {project.techs.map((tech, idx) => (
                      <img key={idx} src={getTechIcon(tech)} alt={tech} title={tech} />
                    ))}
                  </div>
                </div>
              </div>
